...
.setDescription(`**${msgObject.author}, You must mention a valid user to Kick.**`)
.setColor("PURPLE")
let embed1 = new Discord.MessageEmbed()
.setDescription(`**${msgObject.author}, I cannot Kick a staff member.**`)
.setColor("PURPLE")
let embed4 = new Discord.MessageEmbed()
.setDescription(`**${msgObject.author}, I cannot Kick that person.**`)
.setColor("PURPLE")
let staffrole = msgObject.member.guild.roles.cache.find(r => r.name === "Moderator").id;
...
.setDescription(`You were kicked at ${msgObject.member.guild.name},\n**Kick Note**\nModerator: ${msgObject.author.name}\nReason: ${args.slice(1).join(" ")}`)
...
.setFooter(`Kick Reason: ${args.slice(1).join(" ")}`)
msgObject.member.guild.kick(mentioned);
