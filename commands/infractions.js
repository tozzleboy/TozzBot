    ...
    runCommand(args, msgObject, client) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let embed3 = new Discord.MessageEmbed()
                .setDescription(`**${msgObject.author}, You must mention a valid user to check.**`)
                .setColor("PURPLE")
            let embed1 = new Discord.MessageEmbed()
                .setDescription(`**${msgObject.author}, I cannot warn a staff member.**`)
                .setColor("PURPLE")
            let embed4 = new Discord.MessageEmbed()
                .setDescription(`**${msgObject.author}, I cannot warn that person.**`)
                .setColor("PURPLE")
